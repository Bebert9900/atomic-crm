...
// Same contract as morning_brief but runs on DeepSeek V3.
// Kept as a separate skill so you can A/B the two providers in production
// (compare quality / latency / cost side by side in the ops dashboard).
...
export const morningBriefDeepseekSkill: SkillManifest<
...
- search_deals(stage=..., updated_since=il y a 2 semaines) pour deals stagnants
